...
import _recuperacao from  "./recuperacao.js";
...
export default function initModels(sequelize) {
  ...
  const recuperacao = _recuperacao.init(sequelize, DataTypes);
  ...
  const tb_mario = _tb_mario.init(sequelize, DataTypes);
  const tb_patricia = _tb_patricia.init(sequelize, DataTypes);
  ...
  const td_nicole = _td_nicole.init(sequelize, DataTypes);
