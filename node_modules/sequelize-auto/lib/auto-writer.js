...
class AutoWriter {
    ...
    createAssociations(typeScript) {
        ...
        rels.forEach(rel => {
            if (rel.isM2M) {
                const asprop = types_1.recase(this.options.caseProp, types_1.pluralize(rel.childProp));
                ...
                const asParentProp = types_1.recase(this.options.caseProp, rel.parentProp);
                ...
                const asChildProp = types_1.recase(this.options.caseProp, rel.childProp);
    ...
    createESMDInitString(tables, assoc) {
